...
pub const ResultVTable = struct {
    resultProperties: *const fn (*anyopaque) anyerror![]const ResultProperty,
};
...
pub const Result = struct {
    ...
    pub fn resultProperties(self: Result) anyerror![]const ResultProperty {
...
pub const ResultObject = struct {
    ...
    pub const VTable = struct {
        resultProperties: *const fn (*const anyopaque, Allocator) anyerror![]ResultProperty,
    };

    pub fn resultProperties(self: ResultObject, allocator: Allocator) anyerror![]ResultProperty {
...
fn legacyResultProperties(ctx: *const anyopaque, allocator: Allocator) anyerror![]ResultProperty {
